		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 text-center">
					<h1 class="white"><strong>Podrás tener </strong>a la mano </h1>
		...
		<div class="container">
			<div class="row">
				<div class="owl-carousel owl-theme">
				    <div class="item"><img src="images/property-img2.jpg" alt=""></div>
				    <div class="item"><img src="images/property-img2.jpg" alt=""></div>
				    <div class="item"><img src="images/property-img2.jpg" alt=""></div>
				    <div class="item"><img src="images/property-img2.jpg" alt=""></div>
				    <div class="item"><img src="images/property-img2.jpg" alt=""></div>
	...
	<section class="module services">
	  <div class="container">
	    ...
	    <div class="module-header">
	      <h2>Great listings and <strong>better prices</strong></h2>
